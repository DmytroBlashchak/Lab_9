...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("Hello, It's project 9, please enter a mode you want to use here. If you don`t know which modes are available, just type 2 to get a 'Help'");
        ...
        switch (mode) {
            case 1: // TASK
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        TestApplication app = TestApplication.createAndShow();
                    }
                });
